...
namespace Proyecto_Adivina_la_Palabra
{
    public partial class Form1 : Form
    {
        ...
        public Form1(string nombre)
        {
            ...
            this.Text = "Jugando como: " + nombreJugador;
            Setup();
        }

        public Form1() { InitializeComponent(); Setup(); }
        ...
        private void textBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter) // Si la tecla presionada es enter se ejecuta lo siguiente
            {
                if (words[i].ToLower() == textBox1.Text.ToLower()) // Asegurarnos que las palabras esten en minusculas
                {
                    ...
                    int puntosPalabra = Math.Max(0, 100 - (guessed * 10));
                    puntuacionTotal += puntosPalabra;
                    ...
                    else
                    {
                        ...
                        GuardarPuntuacion();
                        MessageBox.Show($"Felicidaes {nombreJugador}!\nPuntuacion final {puntuacionTotal}", "Fin del Juego");
                        return;
                    }
                }
                else
        ...
        private void Setup() // Metodo que cargara las palabras de la lista
        {
            ...
            {
                MessageBox.Show("No se encuentra el archivo words.txt");
            }
        }
        ...
        {
            string linea = $"{nombreJugador} - {puntuacionTotal} puntos - {DateTime.Now}\n";
            File.AppendAllText("puntuaciones.txt", linea);
        }
